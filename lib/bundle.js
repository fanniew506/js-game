...
/***/ function(module, exports) {
	...
	function giveBomb() {
	  ...
	  createjs.Tween.get(bomb).to({
	    ...
	    scaleX: 3.5,
	    scaleY: 3.5
	  }, levels[currentLevel].itemSpeed, createjs.Ease.quadIn);
	  itemIdx += 1;
	}
	...
	function jump() {
	  ...
	  createjs.Tween.get(jumping).to({ y: currentY - 150 }, 400, createjs.Ease.quadInOut).to({ y: currentY }, 400, createjs.Ease.quadInOut);
	  createjs.Tween.get(shadow).to({ x: currentX + 50, y: currentY + 100, scaleX: 0, scaleY: 0 }, 400, createjs.Ease.quadInOut).to({ x: currentX, y: currentY, scaleX: 1, scaleY: 1 }, 400, createjs.Ease.quadInOut);
	  setTimeout(function () {
	...
	function showHelp() {
	  stage.removeAllChildren();
	  var help = new createjs.Bitmap("./images/help.png");
	  help.x = 0;
	  help.y = 0;
	  help.name = "helpmenu";
	  stage.addChild(help);
